...
#
# - objective: (1) `structural_mass` minimization (tower+monpile)
#
# ### TODO:
# - add monopile in geometry and modelling_options yaml files
# - change objective 
...
# M4W run directory
dir_m4w_run = mydir + os.sep + "M4W_02_tower_monopile"
