...
results_dir = "outputs"
script_dir = os.path.dirname(os.path.abspath(__file__)) # get path to this file
results_path = os.path.join(script_dir, results_dir)
os.makedirs(results_path, exist_ok=True)

loc_n2 = os.path.join(results_path, "n2.html")
loc_save_data = os.path.join(results_path, "eg_tlp")
...
if flag_save_new_data: fileIO.save_data(loc_save_data, prob)
# ===============================================================
